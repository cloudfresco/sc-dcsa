...
func (bs *BkgService) CreateBooking(ctx context.Context, in *bkgproto.CreateBookingRequest) (*bkgproto.CreateBookingResponse, error) {
	fmt.Println("bkservices/bkg_service.go:CreateBooking() started")
	fmt.Println("bkservices/bkg_service.go:CreateBooking() started in", in)
	fmt.Println("bkservices/bkg_service.go:CreateBooking() in.UserId", in.UserId)
	fmt.Println("bkservices/bkg_service.go:CreateBooking() in.UserEmail", in.UserEmail)
	...
	fmt.Println("bkservices/bkg_service.go:CreateBooking() user is", user)
	fmt.Println("bkservices/bkg_service.go:CreateBooking() err is", err)
