...
func (h *WfHelper) StartWorkflowWithCtx(
	ctx context.Context,
	options client.StartWorkflowOptions,
	workflow interface{},
	args ...interface{},
...
func (h *WfHelper) SignalWithStartWorkflowWithCtx(ctx context.Context, workflowID string, signalName string, signalArg interface{},
...
func (h *WfHelper) ConsistentQueryWorkflow(
	valuePtr interface{},
...
func (h *WfHelper) registerWorkflowAndActivity(worker worker.Worker) {
