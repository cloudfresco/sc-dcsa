...
const (
	ConsignmentItemService_CreateConsignmentItem_FullMethodName                               = "/internal.proto.ebl.v1.ConsignmentItemService/CreateConsignmentItem"
	ConsignmentItemService_CreateConsignmentItemsByShippingInstructionIdAndTOs_FullMethodName = "/internal.proto.ebl.v1.ConsignmentItemService/CreateConsignmentItemsByShippingInstructionIdAndTOs"
	ConsignmentItemService_FetchConsignmentItemsTOByShippingInstructionId_FullMethodName      = "/internal.proto.ebl.v1.ConsignmentItemService/FetchConsignmentItemsTOByShippingInstructionId"
	ConsignmentItemService_RemoveConsignmentItemsByShippingInstructionId_FullMethodName       = "/internal.proto.ebl.v1.ConsignmentItemService/RemoveConsignmentItemsByShippingInstructionId"
)
...
func (c *consignmentItemServiceClient) CreateConsignmentItem(ctx context.Context, in *CreateConsignmentItemRequest, opts ...grpc.CallOption) (*CreateConsignmentItemResponse, error) {
	...
	err := c.cc.Invoke(ctx, ConsignmentItemService_CreateConsignmentItem_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consignmentItemServiceClient) CreateConsignmentItemsByShippingInstructionIdAndTOs(ctx context.Context, in *CreateConsignmentItemsByShippingInstructionIdAndTOsRequest, opts ...grpc.CallOption) (*CreateConsignmentItemsByShippingInstructionIdAndTOsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ConsignmentItemService_CreateConsignmentItemsByShippingInstructionIdAndTOs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consignmentItemServiceClient) FetchConsignmentItemsTOByShippingInstructionId(ctx context.Context, in *FetchConsignmentItemsTOByShippingInstructionIdRequest, opts ...grpc.CallOption) (*FetchConsignmentItemsTOByShippingInstructionIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, ConsignmentItemService_FetchConsignmentItemsTOByShippingInstructionId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consignmentItemServiceClient) RemoveConsignmentItemsByShippingInstructionId(ctx context.Context, in *RemoveConsignmentItemsByShippingInstructionIdRequest, opts ...grpc.CallOption) (*RemoveConsignmentItemsByShippingInstructionIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, ConsignmentItemService_RemoveConsignmentItemsByShippingInstructionId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var ConsignmentItemService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "internal.proto.ebl.v1.ConsignmentItemService",
	...
	Metadata: "internal/proto/ebl/v1/consignmentitem.proto",
}
