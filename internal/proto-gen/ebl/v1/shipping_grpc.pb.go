...
const (
	ShippingService_CreateShipment_FullMethodName                                     = "/internal.proto.ebl.v1.ShippingService/CreateShipment"
	ShippingService_GetShipments_FullMethodName                                       = "/internal.proto.ebl.v1.ShippingService/GetShipments"
	ShippingService_GetShipment_FullMethodName                                        = "/internal.proto.ebl.v1.ShippingService/GetShipment"
	ShippingService_GetShipmentByPk_FullMethodName                                    = "/internal.proto.ebl.v1.ShippingService/GetShipmentByPk"
	ShippingService_CreateTransport_FullMethodName                                    = "/internal.proto.ebl.v1.ShippingService/CreateTransport"
	ShippingService_GetTransports_FullMethodName                                      = "/internal.proto.ebl.v1.ShippingService/GetTransports"
	ShippingService_GetTransport_FullMethodName                                       = "/internal.proto.ebl.v1.ShippingService/GetTransport"
	ShippingService_GetTransportByPk_FullMethodName                                   = "/internal.proto.ebl.v1.ShippingService/GetTransportByPk"
	ShippingService_FindCarrierBookingReferenceByShippingInstructionId_FullMethodName = "/internal.proto.ebl.v1.ShippingService/FindCarrierBookingReferenceByShippingInstructionId"
)
...
func (c *shippingServiceClient) CreateShipment(ctx context.Context, in *CreateShipmentRequest, opts ...grpc.CallOption) (*CreateShipmentResponse, error) {
	...
	err := c.cc.Invoke(ctx, ShippingService_CreateShipment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shippingServiceClient) GetShipments(ctx context.Context, in *GetShipmentsRequest, opts ...grpc.CallOption) (*GetShipmentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ShippingService_GetShipments_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shippingServiceClient) GetShipment(ctx context.Context, in *GetShipmentRequest, opts ...grpc.CallOption) (*GetShipmentResponse, error) {
	...
	err := c.cc.Invoke(ctx, ShippingService_GetShipment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shippingServiceClient) GetShipmentByPk(ctx context.Context, in *GetShipmentByPkRequest, opts ...grpc.CallOption) (*GetShipmentByPkResponse, error) {
	...
	err := c.cc.Invoke(ctx, ShippingService_GetShipmentByPk_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shippingServiceClient) CreateTransport(ctx context.Context, in *CreateTransportRequest, opts ...grpc.CallOption) (*CreateTransportResponse, error) {
	...
	err := c.cc.Invoke(ctx, ShippingService_CreateTransport_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shippingServiceClient) GetTransports(ctx context.Context, in *GetTransportsRequest, opts ...grpc.CallOption) (*GetTransportsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ShippingService_GetTransports_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shippingServiceClient) GetTransport(ctx context.Context, in *GetTransportRequest, opts ...grpc.CallOption) (*GetTransportResponse, error) {
	...
	err := c.cc.Invoke(ctx, ShippingService_GetTransport_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shippingServiceClient) GetTransportByPk(ctx context.Context, in *GetTransportByPkRequest, opts ...grpc.CallOption) (*GetTransportByPkResponse, error) {
	...
	err := c.cc.Invoke(ctx, ShippingService_GetTransportByPk_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shippingServiceClient) FindCarrierBookingReferenceByShippingInstructionId(ctx context.Context, in *FindCarrierBookingReferenceByShippingInstructionIdRequest, opts ...grpc.CallOption) (*FindCarrierBookingReferenceByShippingInstructionIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, ShippingService_FindCarrierBookingReferenceByShippingInstructionId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var ShippingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "internal.proto.ebl.v1.ShippingService",
	...
	Metadata: "internal/proto/ebl/v1/shipping.proto",
}
