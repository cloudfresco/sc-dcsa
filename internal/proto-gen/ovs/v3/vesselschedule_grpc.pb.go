...
const (
	VesselScheduleService_CreateVesselSchedule_FullMethodName  = "/internal.proto.ovs.v3.VesselScheduleService/CreateVesselSchedule"
	VesselScheduleService_GetVesselSchedules_FullMethodName    = "/internal.proto.ovs.v3.VesselScheduleService/GetVesselSchedules"
	VesselScheduleService_GetVesselSchedule_FullMethodName     = "/internal.proto.ovs.v3.VesselScheduleService/GetVesselSchedule"
	VesselScheduleService_GetVesselScheduleByPk_FullMethodName = "/internal.proto.ovs.v3.VesselScheduleService/GetVesselScheduleByPk"
	VesselScheduleService_CreateVessel_FullMethodName          = "/internal.proto.ovs.v3.VesselScheduleService/CreateVessel"
	VesselScheduleService_GetVessels_FullMethodName            = "/internal.proto.ovs.v3.VesselScheduleService/GetVessels"
	VesselScheduleService_GetVessel_FullMethodName             = "/internal.proto.ovs.v3.VesselScheduleService/GetVessel"
	VesselScheduleService_GetVesselByPk_FullMethodName         = "/internal.proto.ovs.v3.VesselScheduleService/GetVesselByPk"
)
...
func (c *vesselScheduleServiceClient) CreateVesselSchedule(ctx context.Context, in *CreateVesselScheduleRequest, opts ...grpc.CallOption) (*CreateVesselScheduleResponse, error) {
	...
	err := c.cc.Invoke(ctx, VesselScheduleService_CreateVesselSchedule_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vesselScheduleServiceClient) GetVesselSchedules(ctx context.Context, in *GetVesselSchedulesRequest, opts ...grpc.CallOption) (*GetVesselSchedulesResponse, error) {
	...
	err := c.cc.Invoke(ctx, VesselScheduleService_GetVesselSchedules_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vesselScheduleServiceClient) GetVesselSchedule(ctx context.Context, in *GetVesselScheduleRequest, opts ...grpc.CallOption) (*GetVesselScheduleResponse, error) {
	...
	err := c.cc.Invoke(ctx, VesselScheduleService_GetVesselSchedule_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vesselScheduleServiceClient) GetVesselScheduleByPk(ctx context.Context, in *GetVesselScheduleByPkRequest, opts ...grpc.CallOption) (*GetVesselScheduleByPkResponse, error) {
	...
	err := c.cc.Invoke(ctx, VesselScheduleService_GetVesselScheduleByPk_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vesselScheduleServiceClient) CreateVessel(ctx context.Context, in *CreateVesselRequest, opts ...grpc.CallOption) (*CreateVesselResponse, error) {
	...
	err := c.cc.Invoke(ctx, VesselScheduleService_CreateVessel_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vesselScheduleServiceClient) GetVessels(ctx context.Context, in *GetVesselsRequest, opts ...grpc.CallOption) (*GetVesselsResponse, error) {
	...
	err := c.cc.Invoke(ctx, VesselScheduleService_GetVessels_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vesselScheduleServiceClient) GetVessel(ctx context.Context, in *GetVesselRequest, opts ...grpc.CallOption) (*GetVesselResponse, error) {
	...
	err := c.cc.Invoke(ctx, VesselScheduleService_GetVessel_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vesselScheduleServiceClient) GetVesselByPk(ctx context.Context, in *GetVesselByPkRequest, opts ...grpc.CallOption) (*GetVesselByPkResponse, error) {
	...
	err := c.cc.Invoke(ctx, VesselScheduleService_GetVesselByPk_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var VesselScheduleService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "internal.proto.ovs.v3.VesselScheduleService",
	...
	Metadata: "internal/proto/ovs/v3/vesselschedule.proto",
}
