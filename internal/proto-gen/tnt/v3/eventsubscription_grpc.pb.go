...
const (
	EventSubscriptionService_CreateEventSubscription_FullMethodName     = "/internal.proto.tnt.v3.EventSubscriptionService/CreateEventSubscription"
	EventSubscriptionService_GetEventSubscriptions_FullMethodName       = "/internal.proto.tnt.v3.EventSubscriptionService/GetEventSubscriptions"
	EventSubscriptionService_FindEventSubscriptionByID_FullMethodName   = "/internal.proto.tnt.v3.EventSubscriptionService/FindEventSubscriptionByID"
	EventSubscriptionService_DeleteEventSubscriptionByID_FullMethodName = "/internal.proto.tnt.v3.EventSubscriptionService/DeleteEventSubscriptionByID"
	EventSubscriptionService_UpdateEventSubscription_FullMethodName     = "/internal.proto.tnt.v3.EventSubscriptionService/UpdateEventSubscription"
)
...
func (c *eventSubscriptionServiceClient) CreateEventSubscription(ctx context.Context, in *CreateEventSubscriptionRequest, opts ...grpc.CallOption) (*CreateEventSubscriptionResponse, error) {
	...
	err := c.cc.Invoke(ctx, EventSubscriptionService_CreateEventSubscription_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventSubscriptionServiceClient) GetEventSubscriptions(ctx context.Context, in *GetEventSubscriptionsRequest, opts ...grpc.CallOption) (*GetEventSubscriptionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, EventSubscriptionService_GetEventSubscriptions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventSubscriptionServiceClient) FindEventSubscriptionByID(ctx context.Context, in *FindEventSubscriptionByIDRequest, opts ...grpc.CallOption) (*FindEventSubscriptionByIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, EventSubscriptionService_FindEventSubscriptionByID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventSubscriptionServiceClient) DeleteEventSubscriptionByID(ctx context.Context, in *DeleteEventSubscriptionByIDRequest, opts ...grpc.CallOption) (*DeleteEventSubscriptionByIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, EventSubscriptionService_DeleteEventSubscriptionByID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventSubscriptionServiceClient) UpdateEventSubscription(ctx context.Context, in *UpdateEventSubscriptionRequest, opts ...grpc.CallOption) (*UpdateEventSubscriptionResponse, error) {
	...
	err := c.cc.Invoke(ctx, EventSubscriptionService_UpdateEventSubscription_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var EventSubscriptionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "internal.proto.tnt.v3.EventSubscriptionService",
	...
	Metadata: "internal/proto/tnt/v3/eventsubscription.proto",
}
