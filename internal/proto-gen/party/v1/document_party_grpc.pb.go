...
const (
	DocumentPartyService_CreateDocumentParty_FullMethodName                            = "/internal.proto.party.v1.DocumentPartyService/CreateDocumentParty"
	DocumentPartyService_CreateDocumentPartiesByBookingID_FullMethodName               = "/internal.proto.party.v1.DocumentPartyService/CreateDocumentPartiesByBookingID"
	DocumentPartyService_CreateDocumentPartiesByShippingInstructionID_FullMethodName   = "/internal.proto.party.v1.DocumentPartyService/CreateDocumentPartiesByShippingInstructionID"
	DocumentPartyService_FetchDocumentPartiesByBookingID_FullMethodName                = "/internal.proto.party.v1.DocumentPartyService/FetchDocumentPartiesByBookingID"
	DocumentPartyService_FetchDocumentPartiesByByShippingInstructionID_FullMethodName  = "/internal.proto.party.v1.DocumentPartyService/FetchDocumentPartiesByByShippingInstructionID"
	DocumentPartyService_ResolveDocumentPartiesForShippingInstructionID_FullMethodName = "/internal.proto.party.v1.DocumentPartyService/ResolveDocumentPartiesForShippingInstructionID"
)
...
func (c *documentPartyServiceClient) CreateDocumentParty(ctx context.Context, in *CreateDocumentPartyRequest, opts ...grpc.CallOption) (*CreateDocumentPartyResponse, error) {
	...
	err := c.cc.Invoke(ctx, DocumentPartyService_CreateDocumentParty_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *documentPartyServiceClient) CreateDocumentPartiesByBookingID(ctx context.Context, in *CreateDocumentPartiesByBookingIDRequest, opts ...grpc.CallOption) (*CreateDocumentPartiesByBookingIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, DocumentPartyService_CreateDocumentPartiesByBookingID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *documentPartyServiceClient) CreateDocumentPartiesByShippingInstructionID(ctx context.Context, in *CreateDocumentPartiesByShippingInstructionIDRequest, opts ...grpc.CallOption) (*CreateDocumentPartiesByShippingInstructionIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, DocumentPartyService_CreateDocumentPartiesByShippingInstructionID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *documentPartyServiceClient) FetchDocumentPartiesByBookingID(ctx context.Context, in *FetchDocumentPartiesByBookingIDRequest, opts ...grpc.CallOption) (*FetchDocumentPartiesByBookingIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, DocumentPartyService_FetchDocumentPartiesByBookingID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *documentPartyServiceClient) FetchDocumentPartiesByByShippingInstructionID(ctx context.Context, in *FetchDocumentPartiesByByShippingInstructionIDRequest, opts ...grpc.CallOption) (*FetchDocumentPartiesByByShippingInstructionIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, DocumentPartyService_FetchDocumentPartiesByByShippingInstructionID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *documentPartyServiceClient) ResolveDocumentPartiesForShippingInstructionID(ctx context.Context, in *ResolveDocumentPartiesForShippingInstructionIDRequest, opts ...grpc.CallOption) (*ResolveDocumentPartiesForShippingInstructionIDResponse, error) {
	...
	err := c.cc.Invoke(ctx, DocumentPartyService_ResolveDocumentPartiesForShippingInstructionID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var DocumentPartyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "internal.proto.party.v1.DocumentPartyService",
	...
	Metadata: "internal/proto/party/v1/document_party.proto",
}
