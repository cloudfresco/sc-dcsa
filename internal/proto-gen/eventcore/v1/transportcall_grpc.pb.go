...
const (
	TransportCallService_CreateTransportCall_FullMethodName  = "/internal.proto.eventcore.v1.TransportCallService/CreateTransportCall"
	TransportCallService_GetTransportCalls_FullMethodName    = "/internal.proto.eventcore.v1.TransportCallService/GetTransportCalls"
	TransportCallService_FindTransportCall_FullMethodName    = "/internal.proto.eventcore.v1.TransportCallService/FindTransportCall"
	TransportCallService_GetTransportCallByPk_FullMethodName = "/internal.proto.eventcore.v1.TransportCallService/GetTransportCallByPk"
)
...
func (c *transportCallServiceClient) CreateTransportCall(ctx context.Context, in *CreateTransportCallRequest, opts ...grpc.CallOption) (*CreateTransportCallResponse, error) {
	...
	err := c.cc.Invoke(ctx, TransportCallService_CreateTransportCall_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transportCallServiceClient) GetTransportCalls(ctx context.Context, in *GetTransportCallsRequest, opts ...grpc.CallOption) (*GetTransportCallsResponse, error) {
	...
	err := c.cc.Invoke(ctx, TransportCallService_GetTransportCalls_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transportCallServiceClient) FindTransportCall(ctx context.Context, in *FindTransportCallRequest, opts ...grpc.CallOption) (*FindTransportCallResponse, error) {
	...
	err := c.cc.Invoke(ctx, TransportCallService_FindTransportCall_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transportCallServiceClient) GetTransportCallByPk(ctx context.Context, in *GetTransportCallByPkRequest, opts ...grpc.CallOption) (*GetTransportCallByPkResponse, error) {
	...
	err := c.cc.Invoke(ctx, TransportCallService_GetTransportCallByPk_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var TransportCallService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "internal.proto.eventcore.v1.TransportCallService",
	...
	Metadata: "internal/proto/eventcore/v1/transportcall.proto",
}
