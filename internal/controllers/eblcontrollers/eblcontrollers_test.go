...
import (
	...
	eblservices "github.com/cloudfresco/sc-dcsa/internal/services/eblservices"
	partyservices "github.com/cloudfresco/sc-dcsa/internal/services/partyservices"

	eblworkers "github.com/cloudfresco/sc-dcsa/internal/workers/eblworkers"
...
func TestMain(m *testing.M) {
	...
	pwd, _ := os.Getwd()
	go eblservices.StartEblServer(logEbl, true, pwd, dbOpt, redisOpt, mailerOpt, grpcServerOpt, jwtOpt, oauthOpt, userOpt, uptraceOpt, dbService, redisService, mailerService, currencyService)
	...
	go eblworkers.StartEblWorker(log, true, pwd, grpcServerOpt, configFilePath)
