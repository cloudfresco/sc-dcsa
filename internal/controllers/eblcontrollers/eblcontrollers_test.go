...
func TestMain(m *testing.M) {
	...
	pwd, _ := os.Getwd()
	go eblservices.StartEblServer(logEbl, true, pwd, dbOpt, redisOpt, mailerOpt, grpcServerOpt, jwtOpt, oauthOpt, userOpt, uptraceOpt, dbService, redisService, mailerService)
