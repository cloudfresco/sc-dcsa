...
func TestCreateBooking(t *testing.T) {
	...
	req, err := http.NewRequest("POST", "https://localhost:9061/v2/bookings", bytes.NewBuffer(data))
	if err != nil {
		t.Error(err)
		return
	}
...
func TestUpdateBooking(t *testing.T) {
	...
	req, err := http.NewRequest("PUT", "https://localhost:9061/v2/bookings/CARRIER_BOOKING_REQUEST_REFERENCE_01", bytes.NewBuffer(data))
	if err != nil {
		t.Error(err)
		return
	}
