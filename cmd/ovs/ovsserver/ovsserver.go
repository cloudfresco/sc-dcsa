...
import (
	...
	"github.com/cloudfresco/sc-dcsa/internal/services/ovsservices"
...
func main() {
	...
	log := config.SetUpLogging(logOpt.OvsPath)
	...
	pwd, _ := os.Getwd()
	ovsservices.StartOvsServer(log, false, pwd, dbOpt, redisOpt, mailerOpt, grpcServerOpt, jwtOpt, oauthOpt, userOpt, uptraceOpt, dbService, redisService, mailerService)
}
