...
import (
	...
	"github.com/cloudfresco/sc-dcsa/internal/services/eblservices"
...
func main() {
	...
	log := config.SetUpLogging(logOpt.EblPath)
	...
	pwd, _ := os.Getwd()
	eblservices.StartEblServer(log, false, pwd, dbOpt, redisOpt, mailerOpt, grpcServerOpt, jwtOpt, oauthOpt, userOpt, uptraceOpt, dbService, redisService, mailerService, currencyService)
}
