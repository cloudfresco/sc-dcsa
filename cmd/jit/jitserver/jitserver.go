...
import (
	...
	"github.com/cloudfresco/sc-dcsa/internal/services/jitservices"
...
func main() {
	...
	log := config.SetUpLogging(logOpt.JitPath)
	...
	pwd, _ := os.Getwd()
	jitservices.StartJitServer(log, false, pwd, dbOpt, redisOpt, mailerOpt, grpcServerOpt, jwtOpt, oauthOpt, userOpt, uptraceOpt, dbService, redisService, mailerService)
}
