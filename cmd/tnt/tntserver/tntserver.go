...
import (
	...
	"github.com/cloudfresco/sc-dcsa/internal/services/tntservices"
...
func main() {
	...
	log := config.SetUpLogging(logOpt.TntPath)
	...
	pwd, _ := os.Getwd()
	tntservices.StartTntServer(log, false, pwd, dbOpt, redisOpt, mailerOpt, grpcServerOpt, jwtOpt, oauthOpt, userOpt, uptraceOpt, dbService, redisService, mailerService)
}
